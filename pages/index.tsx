  ...
  return (
    <Layout title="IT Quiz">
      ...
      <div className='w-full flex flex-col space-y-1 items-center justify-center'>
        <button onClick={() => router.push(`/quiz/1`)} className='px-4 py-2 w-2/3 rounded-xl text-slate-700 text-2xl font-bold bg-white text-center shadow-md hover:text-slate-900 hover:border-2'>시작하기</button>
        <Link href={`/login`}>
